...
public class RandomUtil {
    ...
    public static final String CAPITALLETTERCHAR = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
     ...
     * @return 随机字符串
     */
    public static String getCapitaString(int length) {
        StringBuffer sb = new StringBuffer();
        Random random = new Random();
        for (int i = 0; i < length; i++) {
            sb.append(CAPITALLETTERCHAR.charAt(random.nextInt(CAPITALLETTERCHAR.length())));
        }
        return sb.toString();
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("返回一个定长的随机纯字母字符串(只包含数字):" + generateNumber(10));
        ...
        System.out.println("返回一个定长的随机纯大写字母字符串:" + getCapitaString(1));
        System.out.println("返回一个定长的随机纯大写字母字符串 + 四个数字:" + RandomUtil.getCapitaString(1) + RandomUtil.generateNumber(4));
    }
}
